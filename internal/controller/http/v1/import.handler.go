...
// // @Failure 400 {object} v1.Response
// // @Failure 500 {object} v1.Response
// // @Router /import-detail/product-marking/{id} [get]
// func (h *ImportHandler) ProductMarking(c *gin.Context) {
// 	var importDetail []struct {
// 		Id            string            `gorm:"id" json:"id"`
// 		ProductId     string            `gorm:"product_id" json:"product_id"`
// 		ReceivedCount int               `gorm:"received_count" json:"received_count"`
// 		Marking       utils.StringArray `gorm:"type:varchar[]" json:"marking"`
// 	}
// 	err := h.db.Debug().Raw(`
// 	select id, product_id, received_count, marking
// 	from import_details
// 	where import_id = ?
// 	AND array_length(import_details.marking, 1) > 0;
// 	`, c.Param("id")).Scan(&importDetail).Error
// 	if err != nil {
// 		h.log.Error(err)
// 		handleResponse(c, InternalError, err.Error())
// 		return
...
// 	for _, item := range importDetail {
// 		for _, marking := range item.Marking {
// 			err = h.db.Exec(`
// 				INSERT INTO product_markings (import_detail_id, product_id, marking)
// 				SELECT ?, ?, ?
// 				WHERE NOT EXISTS (
// 					SELECT 1 FROM product_markings WHERE marking = ?
// 				);`,
// 				item.Id, item.ProductId, marking, marking).Error
// 			if err != nil {
// 				h.log.Error("Failed to insert marking: ", err)
// 				handleResponse(c, InternalError, err.Error())
// 				return
// 			}
// 		}
