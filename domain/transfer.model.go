...
type Transfer struct {
	...
	FromStore         NullStruct[Store]    `gorm:"-" json:"store"`
	ToStore           NullStruct[Store]    `gorm:"-" json:"to_store"`
	CreatedBy         NullStruct[Employee] `gorm:"-" json:"created_by"`
	UpdatedBy         NullStruct[Employee] `gorm:"-" json:"updated_by"`
	AcceptedBy        NullStruct[Employee] `gorm:"-" json:"accepted_by"`
}
