...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.AutoOrderRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/auto-order-detail/change-quantity/{id}": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "description": "Adjusted Order Quantity",
                        "name": "input",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.AdjustedOrderQuantity"
                        }
                    }
                ],
                "responses": {
        ...
        "/cash_box_operation/closed-info/{cash_box_id}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/customer/export-excel-discount-cards": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/customer/list-discount-cards": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Search by customer name or phone or barcode",
                        "name": "search",
                        "in": "query"
                    },
                    {
        ...
        "/finance-category": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Finance category information",
                        "name": "finance_category",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.FinanceCategoryRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "delete": {
                ...
                "parameters": [
                    {
                        "description": "Finance category IDs",
                        "name": "id",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/finance-operation": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Finance operation information",
                        "name": "input",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.FinanceOperationRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/finance-operation/{id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Finance operation ID",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
        ...
        "/helper/attach-category-to-products": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/helper/picture": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "MXIK code of the product",
                        "name": "mxik_code",
                        "in": "query",
                        "required": true
                    }
        ...
        "/import-detail/export-excel": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Received Amount From",
                        "name": "received_amount_from",
                        "in": "query"
                    },
                    {
                        "type": "integer",
        ...
        "/import-detail/get-stock-status-counts/{id}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/import-detail/list/by-last-updated": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/import/export-excel": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Receive Amount From",
                        "name": "receive_amount_from",
                        "in": "query"
                    },
                    {
                        "type": "integer",
        ...
        "/inventory-detail/detailed-flow": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/inventory/list-status": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Inventory Status (0-\u003enew|1-\u003epending|2-\u003ecompleted)",
                        "name": "status",
                        "in": "query"
                    }
                ],
        ...
        "/logs": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Type might be -\u003e (payme, click, epos, dmed)",
                        "name": "provider_type",
                        "in": "query"
                    },
                    {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.Producer"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.ProductBonusRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/product-bonus/excel-import": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "file",
                        "description": "Excel file (.xlsx) containing bonus data",
                        "name": "file",
                        "in": "formData",
                        "required": true
                    }
        ...
        "/product/exclude": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Exclude Product Request",
                        "name": "exclude",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.ProductExcludeRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/product/min-max": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Min Max request body",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.MinMaxProductRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/product/min-max/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Min Max Product ID",
                        "name": "id",
                        "in": "path",
                        "required": true
                    },
                    {
                        "description": "Min Max update",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.MinMaxProductUpdate"
                        }
                    }
                ],
                "responses": {
        ...
        "/product/photo-alert": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Product Photo Alert Create Body",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.ProductPhotoAlertCreate"
                        }
                    }
                ],
                "responses": {
        ...
        "/product/photo-alert/list": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Category (1=ml/doza noto'g'ri, 2=ishlab chiqaruvchi noto'g'ri, 3=butunlay rasm xato)",
                        "name": "category",
                        "in": "query"
                    },
                    {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.UpdateBarcodeRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/product/update-ostatok/{store_product_id}": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.AsilBelgiTokenRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/rejected-products/export-excel": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "type": "string",
                        "description": "Order type: max_count, min_count, max_amount, min_amount",
                        "name": "order",
                        "in": "query"
                    }
                ],
        ...
        "/report/bonus-products/export-excel": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/report/ostatok-by-date/export-excel": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/domain.ProductStatusReport"
                                        }
                                    }
                                }
                            ]
        ...
        "/report/store-amount/export-excel": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/report/store-summary/export-excel": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/report/top-products/export-excel": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/report/top-seller/export-excel": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/report/top-stores/export-excel": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.RepricingRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.UpdateNewPrice"
                        }
                    }
                ],
                "responses": {
        ...
        "/return/export-nakladnoy": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Nakladnoy PDF file",
                        "schema": {
                            "$ref": "#/definitions/v1.Response"
                        }
                    },
        ...
        "/return/{id}/add-product-by-barcode": {
            "patch": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/sale/pending-list": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Search (sale number or store name)",
                        "name": "search",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Created At Start Date (RFC3339)",
                        "name": "start_date",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Created At End Date (RFC3339)",
                        "name": "end_date",
                        "in": "query"
                    }
                ],
        ...
        "/transfer/{id}/add-product-by-barcode": {
            "patch": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.WriteOffRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/write-off/{id}/add-product-by-barcode": {
            "patch": {
                "security": [
                    {
                        "BearerAuth": []
    ...
    "definitions": {
        ...
        "domain.FinanceOperationRequest": {
            "type": "object",
            "properties": {
                "amount": {
                    "type": "number"
                ...
                "operation_type": {
                    "type": "string",
                    "example": "income||expense||collection"
                },
                "payment_type_id": {
                    "type": "string"
                },
        ...
        "domain.ProductPhotoAlertCreate": {
            "type": "object",
            "required": [
                "category",
                "product_id"
        ...
        "domain.ProductStatusReport": {
            ...
            "properties": {
                ...
                "total_retail_price_sum": {
                    "type": "number"
                },
                "total_retail_price_sum_returned": {
                    "type": "number"
                }
            }
        },
        ...
        "domain.UpdateIsMarking": {
            ...
            "properties": {
                "id": {
                    "description": "this id is store_product_id",
                    "type": "string"
                },
                "is_checking": {
                    "description": "this field is used to check if the product is checking or not",
                    "type": "boolean"
                },
                "is_marking": {
                    "type": "boolean"
